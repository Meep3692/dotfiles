...
our $SCHEMA = [
    ...
    {item => ['~/.local/bin/dmenu_rltw',       'Run command',  'system-run']},
    {item => ['tint2',            'Tint 2',       'tint2']},
    ...
    {item => ['sh -c "xmessage -nearmouse \\"Do you want to shutdown?\\" -buttons Shutdown:0,Cancel:2 -default Cancel && shutdown -h now"', 'Shutdown', 'system-shutdown']}
